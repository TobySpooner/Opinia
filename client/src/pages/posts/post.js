            ...
            <div class="post-container">
                <div class="post-header">
                    <div class="author-info">
                        ...
                        ` : `
                            <div class="author-avatar">${post.username ? post.username[0].toUpperCase() : 'A'}</div>
                        `}
                        <div class="author-details">
                            <div class="author-name">${post.username || 'Anonymous'}</div>
                            <div class="post-metadata">
                                <span class="post-timestamp">${formatRelativeTime(post.created_at)}</span>
                ...
                <div class="post-interactions">
                    <div class="interaction-buttons">
                        <button class="interaction-btn like-btn ${post.liked ? 'liked' : ''}" data-post-id="${post.post_id}">
                            <i class="fas fa-heart"></i>
                            <span class="like-count">${post.post_likes || 0}</span>
            ...
            <div class="comment">
                <div class="comment-header">
                    <div class="comment-author">
                        ...
                        ` : `
                            <div class="comment-avatar">${comment.username ? comment.username[0].toUpperCase() : 'A'}</div>
                        `}
                        <div>
                            <div class="comment-username">${comment.username || 'Anonymous'}</div>
                            <div class="comment-timestamp">${formatRelativeTime(comment.created_at)}</div>
                        </div>
                    </div>
                </div>

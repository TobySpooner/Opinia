        ...
        <div class="user-card" data-user-id="${user.id}">
            <div class="user-header">
                ...
                <div class="user-info">
                    ...
                    <span class="user-role ${user.role_name.toLowerCase()}">${user.role_name}</span>
                </div>
            </div>
...
function filterUsers() {
    const filteredUsers = users.filter(user => {
        const matchesFilter = currentFilter === 'all' || user.role_name === currentFilter;
...
function renderUsers(usersToRender) {
    ...
    usersGrid.innerHTML = usersToRender.map(user => createUserCard(user)).join('');
